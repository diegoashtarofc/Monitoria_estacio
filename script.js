document.addEventListener("DOMContentLoaded", function() {
    const faqList = [
        { question: "Como corrigir problemas técnicos na plataforma?", answer: "Siga esses passos: Primeiro entre no SIA em 'sia.estacio.br/sianet/Logon' em seguida clique em 'Atendimento >>> Reclamações >>> Nova >>> Reclamação Plataformas Digitais'. Em seguida selecione em Causa Raiz N1 onde o erro está acontecendo. Descreva os detalhes do seu problema e anexe um print do erro que você encontrou. Depois é só clicar em continuar e pronto." },
